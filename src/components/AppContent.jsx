...
function LibraryCard({ lib, noteCount, onDelete }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-[var(--border)] bg-[var(--bg)] cursor-pointer active:scale-[0.97] transition-transform relative select-none">
      {/* Coloured header */}
      <div
...
export default function AppContent({ onLock }) {
  ...
  const handleDelete = (id) => {
    ...
    updateStore({ notes: notes.filter((n) => n.libraryId !== id) });
  };
